...
[![Codecov test coverage](https://codecov.io/gh/tractoverse/rtists/graph/badge.svg)](https://app.codecov.io/gh/tractoverse/rtists)
...
defined in the [fiber](https://github.com/tractoverse/fiber) package.

The main function is `plot3d()`, an [S7](https://rconsortium.github.io/S7/)
generic with methods for both `fiber::streamline` and `fiber::bundle` objects.
Figures are rendered by [plotly](https://plotly.com/r/) and are fully
interactive (pan, rotate, zoom).

## Installation

Install the development version from [GitHub](https://github.com/tractoverse/rtists):
...
```{r}
#| label: orientation-fig
#| echo: false
plotly::save_image(
  plot3d(bun),
  file = "man/figures/README-orientation-1.png"
)
knitr::include_graphics("man/figures/README-orientation-1.png")
```
...
plotly::save_image(
  plot3d(bun, color = "FA", palette = "Viridis"),
  file = "man/figures/README-point-fa-1.png"
)
knitr::include_graphics("man/figures/README-point-fa-1.png")
```
...
```{r}
#| label: streamline-fa-fig
#| echo: false
plotly::save_image(
   plot3d(bun, color = "mean_FA", palette = "RdYlBu"),
   file = "man/figures/README-streamline-fa-1.png"
)
knitr::include_graphics("man/figures/README-streamline-fa-1.png")
```
...
plotly::save_image(
  plot3d(bun, color = "steelblue", opacity = 0.7, linewidth = 3),
  file = "man/figures/README-fixed-1.png"
)
knitr::include_graphics("man/figures/README-fixed-1.png")
```
